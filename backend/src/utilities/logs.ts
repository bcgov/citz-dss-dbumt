...
export const MONGODB = {
  ...
  MISSING_VARS: `${mongoDb}${FG.GREEN}[ERROR] ${FM.RESET}${FG.RED}One or more of required env vars is undefined.${FM.RESET}`,
  CONNECTION_ERROR: `${mongoDb}${FG.GREEN}[ERROR] ${FM.RESET}${FG.RED}Connecting to the database:${FM.RESET}`,
};
